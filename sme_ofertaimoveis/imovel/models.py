...
class Proponente(models.Model):
    ...
    nome = models.CharField('Nome', max_length=255)
    cpf_cnpj = models.CharField('CPF / CNPJ', max_length=20, validators=[cpf_cnpj_validation])
    email = models.CharField('E-mail', max_length=255, validators=[validators.EmailValidator()])
    telefone = models.CharField('Telefone', max_length=20, validators=[phone_validation])
    criado_em = models.DateTimeField('Criado em', editable=False, auto_now_add=True)
